...
.addEventListener("submit", function(event) {
    ...
    fetch("https://yogesh73.pythonanywhere.com/api/watches/create/", {
        method: "POST",
        body: formdata,
    })
    .then((response) => {
...
const baseUrl = "https://yogesh73.pythonanywhere.com";
function displayWatches() {
    fetch("https://yogesh73.pythonanywhere.com/api/watches/")
